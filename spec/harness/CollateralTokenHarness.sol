...
contract CollateralTokenHarness is CollateralToken {
    ...
    ////////////////////////////////////////////////////////////////////////////
    constructor() CollateralToken("", "", "https://tokens.rolla.finance/{id}.json") {}

    ////////////////////////////////////////////////////////////////////////////
    //                        Getters for The Internals                       //
    ////////////////////////////////////////////////////////////////////////////
    function getCollateralTokenId(uint256 tokenId) public view returns (uint256) {
        return collateralTokenIds[tokenId];
    }

    function getCollateralTokenInfoTokenAddress(uint256 collateralTokenInfoId) public view returns (address) {
        return idToInfo[collateralTokenInfoId].qTokenAddress;
    }

    function getCollateralTokenInfoTokenAsCollateral(uint256 collateralTokenInfoId) public view returns (address) {
    ...
    function collateralTokenIdsContainsId(uint256 key, uint256 i) public view returns (bool) {
    ...
    function tokenSuppliesContainsCollateralToken(uint256 key) public view returns (bool) {
